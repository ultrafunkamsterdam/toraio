...
class PoolForwardProxy:
    ...
    def __init__(self, pool:Pool, fw_host:str, fw_port:int, listen_host='0.0.0.0', listen_port=80080):
    ...
    async def handle_client(self, reader: asyncio.StreamReader, writer: asyncio.StreamWriter):
        ...
        r, w = await pool.open_connection(self.fw_host, self.fw_port, remote_resolve=True)
    ...
    async def start(self):
        ...
        serv = await asyncio.start_server(self.handle_client, host=self.listen_host, port=self.listen_port)
